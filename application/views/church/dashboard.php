                    ...
                    <div class="row top_tiles">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>New Members</h3>
                                <p>Members having joined since March</p>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>SMS Balance</h3>
                                <p>You have <?php echo (isset($sms_balance)) ? $sms_balance->balance : ''; ?> Units left</p>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>Church DB Size</h3>
                                <p>Total Size of the the Church</p>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <p>Total Converts this March</p>
                            </div>
                        </div>
                    </div>


                    <!-- Section for the Normal Weekly Service and Sunday Service -->
                    <div class="row">
                        <div class="col-md-4">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Bible Study <small>| Tuesdays</small></h2>
                                ...
                                <div class="x_content">
                                    <article class="media event">
                                        ...
                                        <div class="media-body">
                                            <a class="title" href="#">Greater harvest</a>
                        ...
                        <div class="col-md-4">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Faith Clinic <small>| Thursdays</small></h2>
                                ...
                                <div class="x_content">
                                    <article class="media event">
                                        ...
                                        <div class="media-body">
                                            <a class="title" href="#">Healing hands</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                        </div>
                                    </article>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Celebration Service <small>| Sundays</small></h2>
                                ...
                                <div class="x_content">
                                    <article class="media event">
                                        ...
                                        <div class="media-body">
                                            <a class="title" href="#">Rejoice evermore</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                        </div>
                                    </article>
                                </div>
